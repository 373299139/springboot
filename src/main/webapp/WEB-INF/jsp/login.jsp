...
<meta charset="UTF-8">
<title>Iron Man Login Form</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/static/jquery-3.4.1.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/static/index.js"></script>
...
<section class="stark-login">
  <form action="/shiroController/register" method="post" id="loginId">	
    <div id="fade-box">
